...
The Virtual Wire L1 Driver package includes:
| File name | Description |
| ------ | ------ |
| VIRTUAL_WIRE.exe | Driver used by CloudShell Server |
| virtual_wire_runtime_configuration.json | JSON file enabling additional configuration interface for the driver
| Virtual WireResourceConfiguration.xml | An XML file holding all attribute and capabilities of the L1 switches of the same vendor |
...
In step 7 at the above guide, you will need to copy only one exe file, and instead of the runtimeConfig.xml file please copy the virtual_wire_runtime_configuration.json file.
...
### Configuration
*add any relevant information about the different keys in the virtual_wire_runtime_configuration.json file or remove this section*
| Feature | Description |
| ------ | ------ |
